export default [
  ...
  },
  {
    ...
    course: "RS101",
    "lessons": [ // Kept quotes here because `lessons` also contains objects with quoted keys, maintaining consistency if desired. Or remove if you want all keys unquoted.
      {
        _id: "L301",
        name: "Nozzle Design",
